...
class SOSCameraManager(private val context: Context) {

    suspend fun uploadCapturedEvidence(imageUri: Uri?): String? {
        return try {
            ...
            Log.e("SOSCameraManager", "Evidence capture/upload failed", exception)
            null
        }
    }
